...
CREATE TABLE IF NOT EXISTS chat_rooms (
    ...
    creator_id TEXT NOT NULL,         -- 创建者 player_id
    creator_role_id TEXT,             -- 创建者角色 ID
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    is_active INTEGER DEFAULT 1       -- 是否活跃 (1=活跃，0=已关闭)
);
...
CREATE TABLE IF NOT EXISTS chat_messages (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    room_id TEXT,                     -- 房间 ID (NULL 表示世界频道)
    sender_id TEXT NOT NULL,          -- 发送者 player_id
    sender_role_id TEXT,              -- 发送者角色 ID
    content TEXT NOT NULL,            -- 消息内容
    timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    message_type TEXT DEFAULT 'text', -- text/statement/system
